...
class DependencyClient implements \Jaeger\ThriftGen\DependencyIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\Dependency_getDependenciesForTrace_args();
  ...
  public function recv_getDependenciesForTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\Dependency_getDependenciesForTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\Dependency_getDependenciesForTrace_result();
  ...
  public function send_saveDependencies(\Jaeger\ThriftGen\Dependencies $dependencies)
  {
    $args = new \Jaeger\ThriftGen\Dependency_saveDependencies_args();
