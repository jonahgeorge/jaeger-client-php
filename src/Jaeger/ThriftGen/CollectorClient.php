...
class CollectorClient implements \Jaeger\ThriftGen\CollectorIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\Collector_submitBatches_args();
  ...
  public function recv_submitBatches()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\Collector_submitBatches_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\Collector_submitBatches_result();
