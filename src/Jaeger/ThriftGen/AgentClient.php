...
class AgentClient implements \Jaeger\ThriftGen\AgentIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\Agent_emitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function send_emitBatch(\Jaeger\ThriftGen\Batch $batch)
  {
    $args = new \Jaeger\ThriftGen\Agent_emitBatch_args();
    $args->batch = $batch;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
