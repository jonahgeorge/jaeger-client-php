...
class ZipkinCollectorClient implements \Jaeger\ThriftGen\ZipkinCollectorIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\ZipkinCollector_submitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function recv_submitZipkinBatch()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\ZipkinCollector_submitZipkinBatch_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\ZipkinCollector_submitZipkinBatch_result();
