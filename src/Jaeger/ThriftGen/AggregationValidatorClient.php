...
class AggregationValidatorClient implements \Jaeger\ThriftGen\AggregationValidatorIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\AggregationValidator_validateTrace_args();
  ...
  public function recv_validateTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\AggregationValidator_validateTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\AggregationValidator_validateTrace_result();
