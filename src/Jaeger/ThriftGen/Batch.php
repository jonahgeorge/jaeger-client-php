    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'process',
          'type' => TType::STRUCT,
          'class' => '\Jaeger\ThriftGen\Process',
          ),
        2 => array(
          'var' => 'spans',
          'type' => TType::LST,
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->process = new \Jaeger\ThriftGen\Process();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \Jaeger\ThriftGen\Span();
