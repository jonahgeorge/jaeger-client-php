...
class SamplingManagerClient implements \Jaeger\ThriftGen\SamplingManagerIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\SamplingManager_getSamplingStrategy_args();
  ...
  public function recv_getSamplingStrategy()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\SamplingManager_getSamplingStrategy_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\SamplingManager_getSamplingStrategy_result();
