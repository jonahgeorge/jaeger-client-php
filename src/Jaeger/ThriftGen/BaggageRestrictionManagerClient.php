...
class BaggageRestrictionManagerClient implements \Jaeger\ThriftGen\BaggageRestrictionManagerIf {
  ...
  {
    $args = new \Jaeger\ThriftGen\BaggageRestrictionManager_getBaggageRestrictions_args();
  ...
  public function recv_getBaggageRestrictions()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Jaeger\ThriftGen\BaggageRestrictionManager_getBaggageRestrictions_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Jaeger\ThriftGen\BaggageRestrictionManager_getBaggageRestrictions_result();
