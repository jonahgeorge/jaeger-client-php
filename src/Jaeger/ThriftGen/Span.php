...
class Span {
  ...
  /**
   * @var \Jaeger\ThriftGen\Annotation[]
   */
  public $annotations = null;
  /**
   * @var \Jaeger\ThriftGen\BinaryAnnotation[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        6 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Jaeger\ThriftGen\Annotation',
            ),
          ),
        8 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Jaeger\ThriftGen\BinaryAnnotation',
            ),
          ),
        9 => array(
          'var' => 'debug',
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Jaeger\ThriftGen\Annotation();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem11 = null;
              $elem11 = new \Jaeger\ThriftGen\BinaryAnnotation();
